...
All three of these elements are due at the Project A due deadline of Noon 2020-10-20.
...
By 2020-09-22, Dr. Love will provide an R Markdown template for the project "proposal", as well as an (incomplete but useful) sample project report, in each case using a previous year's CHR data.
