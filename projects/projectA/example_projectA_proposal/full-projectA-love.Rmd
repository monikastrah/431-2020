...
In this section you will describe a plot to build a linear regression model to predict your outcome using one of your two quantitative predictors (it's your choice) and the `state` (which should be a factor in your model with Ohio as the baseline category.) 
...
Then, write a paragraph to summarize the key limitations of your work, using the guidance from Analyses 2 and 3.
