...
These questions and the [simulated data you will use](https://github.com/THOMASELOVE/431-2020/tree/master/labs/lab07/data) to answer them are motivated in part by an article[^1] in *Health Psychology* by Stephan et al. Quoting from that article:
