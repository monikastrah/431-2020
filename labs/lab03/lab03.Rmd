...
What is the inter-quartile range of the waiting times, and how does it compare to the standard deviation of the waiting times?

# Question 4 (on the shape of the distribution)

Describe the shape of the waiting times distribution in a few complete sentences. You are welcome to use the histogram you built to help address these issues, and you may also be interested in building an additional plot or two - that's your choice. You should address the following questions in your response.
